...
- **완료**: Phase 0(엔진 보강) + 0.5(wgpu 22 + NotoSansKR 동봉) + 1-A(서바이버 진입점·Player·Camera follow)
- **상태**: engine 30 tests · game lib 3 tests · binary 3개(`game`/`text_demo`/`survivor`) 모두 빌드 통과
- **다음**: Phase 1-B (Zombie 적·스폰)
