...
impl Texture {
    ...
    pub fn from_path(
        ...
        let bytes = std::fs::read(path)
            .unwrap_or_else(|_| panic!("텍스처 파일을 읽지 못했습니다: {path}"));
    ...
    pub fn white(device: &wgpu::Device, queue: &wgpu::Queue, layout: &wgpu::BindGroupLayout) -> Self {
        Self::from_rgba(device, queue, layout, &[255u8, 255, 255, 255], 1, 1, Some("white"))
    }
