//! Vampire Survivors 클론 — Phase 2-D 진입점.
//!
...
//! **Phase 2-D 완료** — Cross(Boomerang) + FireWand + WeaponInventory.slots Vec 변경.
...
fn main() {
    ...
    app.add_system(CrossSystem::default());         // Phase 2-D 신규
    app.add_system(FireWandSystem::default());      // Phase 2-D 신규
