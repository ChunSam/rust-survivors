//! Vampire Survivors 클론 — Phase 2-C 진입점.
//!
...
//! **Phase 2-C 완료** — ProjectileBehavior 일반화 + Knife + Axe 추가.
...
fn main() {
    ...
    // → 무기: Whip → MagicWand(발사) → Knife(발사) → Axe(발사)
    ...
    app.add_system(KnifeSystem::default());        // Phase 2-C 신규
    app.add_system(AxeSystem::default());          // Phase 2-C 신규
